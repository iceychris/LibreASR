...
_AUDIO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='data', full_name='LibreASR.Audio.data', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='sr', full_name='LibreASR.Audio.sr', index=1,
...
_TRANSCRIPT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='data', full_name='LibreASR.Transcript.data', index=0,
...
_TRANSCRIPTEVENT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='transcript', full_name='LibreASR.TranscriptEvent.transcript', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SENTENCEEVENT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='transcript', full_name='LibreASR.SentenceEvent.transcript', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EVENT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='te', full_name='LibreASR.Event.te', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='se', full_name='LibreASR.Event.se', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='content', full_name='LibreASR.Event.content',
...
SentenceEvent = _reflection.GeneratedProtocolMessageType('SentenceEvent', (_message.Message,), {
